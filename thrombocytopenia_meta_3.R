...
# @Last Modified time: 2026-01-27 08:32:00
...
#Rscript thrombocytopenia_meta_2.R -l mian_HWE.csv -g subgroup_children_adults_HWE.csv -s severity.csv  (筛去HWE<0.0001的研究)
# 解析参数
...
forest(meta1,lab.e="Severe",lab.c="Not_Severe")
