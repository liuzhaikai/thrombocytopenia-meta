...
# @Last Modified time: 2026-01-27 08:35:00
...
#Rscript thrombocytopenia_meta_3.R -l mian.csv -g subgroup_children_adults.csv -s severity.csv
#Rscript thrombocytopenia_meta_3.R -l mian_HWE.csv -g subgroup_children_adults_HWE.csv -s severity.csv  (筛去HWE<0.0001的研究)
# 解析参数
