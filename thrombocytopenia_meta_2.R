...
# @Last Modified time: 2026-01-26 15：14：30
...
#Rscript thrombocytopenia_meta_2.R -l mian.csv -g subgroup_children_adults.csv -s severity.csv
# 解析参数
...
n.e<-Main$AG_GG_case+Main$AG_GG_control
event.c<-Main$AA_case
n.c<-Main$AA_case+Main$AA_control
...
n.e<-Sub$AG_GG_case+Sub$AG_GG_control
event.c<-Sub$AA_case
n.c<-Sub$AA_case+Sub$AA_control
...
n.e<-Severity$AG_GG_severe+Severity$AG_GG_not_severe
event.c<-Severity$AA_severe
n.c<-Severity$AA_severe+Severity$AA_not_severe
...
n.e<-Main$AG_case+Main$AG_control
event.c<-Main$AA_case+Main$GG_case
n.c<-Main$AA_case+Main$GG_case+Main$AA_control+Main$GG_control
...
event.e<-Sub$AG_case
n.e<-Sub$AG_case+Sub$AG_control
event.c<-Sub$AA_case+Sub$GG_case
n.c<-Sub$AA_case+Sub$GG_case+Sub$AA_control+Sub$GG_control
...
n.e<-Severity$AG_severe+Severity$AG_not_severe
event.c<-Severity$AA_severe+Severity$GG_severe
n.c<-Severity$AA_severe+Severity$AA_not_severe+Severity$GG_severe+Severity$GG_not_severe
...
n.e<-Main$GG_case+Main$GG_control
event.c<-Main$AA_case
n.c<-Main$AA_case+Main$AA_control
...
event.e<-Sub$GG_case
n.e<-Sub$GG_case+Sub$GG_control
event.c<-Sub$AA_case
n.c<-Sub$AA_case+Sub$AA_control
...
n.e<-Severity$GG_severe+Severity$GG_not_severe
event.c<-Severity$AA_severe
n.c<-Severity$AA_severe+Severity$AA_not_severe
...
event.e<-Main$GG_case
n.e<-Main$GG_case+Main$GG_control
event.c<-Main$AA_AG_case
n.c<-Main$AA_AG_case+Main$AA_AG_control
...
event.e<-Sub$GG_case
n.e<-Sub$GG_case+Sub$GG_control
event.c<-Sub$AA_AG_case
n.c<-Sub$AA_AG_case+Sub$AA_AG_control
...
event.e<-Severity$GG_severe
n.e<-Severity$GG_severe+Severity$GG_not_severe
event.c<-Severity$AA_AG_severe
n.c<-Severity$AA_AG_severe+Severity$AA_AG_not_severe
...
event.e<-Main$G_case
n.e<-Main$G_case+Main$G_control
event.c<-Main$A_case
n.c<-Main$A_case+Main$A_control
...
event.e<-Sub$G_case
n.e<-Sub$G_case+Sub$G_control
event.c<-Sub$A_case
n.c<-Sub$A_case+Sub$A_control
...
n.e<-Severity$G_severe+Severity$G_not_severe
event.c<-Severity$A_severe
n.c<-Severity$A_severe+Severity$A_not_severe
