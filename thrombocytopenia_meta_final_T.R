...
#Rscript thrombocytopenia_meta_4.R -l mian.csv -g subgroup_children_adults.csv -s severity.csv
...
event.e<-Sub$AA_AG_case
n.e<-Sub$AA_AG_case+Sub$GG_case
event.c<-Sub$AA_AG_control
...
n.e<-Main$AG_case+Main$GG_case
event.c<-Main$AG_control
n.c<-Main$AG_control+Main$GG_control
...
event.e<-Sub$AG_case
n.e<-Sub$AG_case+Sub$GG_case
event.c<-Sub$AG_control
n.c<-Sub$AG_control+Sub$GG_control
...
n.e<-Severity$AG_severe+Severity$GG_severe
event.c<-Severity$AG_not_severe
n.c<-Severity$AG_not_severe+Severity$GG_not_severe
